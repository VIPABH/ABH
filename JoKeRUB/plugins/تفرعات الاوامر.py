...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
"★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★ \n شرح عن اوامر الاشراف \n ( `.مشرف` )\n لرفع المستخدم مشرف مع صلاحيات  دون حظر \n (`.مشرف2`) \n - لرفع المستخدم مشرف مع صلاحيات كامله دون الاتصال والحظر واضافة مشرفين \n ( `.مشرف3` ) \n - لرفع المستخدم مشرف مع صلاحيات ضعيفة , مشرف ابتدائي \n ( `.تنزيل الكل` ) \n - بالرد على الشخص مع الامر لإنزاله من الاشراف في المجموعة \n ★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖
"
)
